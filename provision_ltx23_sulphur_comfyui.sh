...
#### most nem kell hf_file "Sikaworld1990/gemma-3-12b-qat-abliterated-sikaworld-fp4-ltx2" "Gemma3-12B-NVFP4-Sikaworld-Pure.safetensors" "$TEXT_DIR/Gemma3-12B-NVFP4-Sikaworld-Pure.safetensors"
...
hf_file "Lightricks/LTX-2.3-22b-IC-LoRA-DubIt" "ltx-2.3-22b-ic-lora-dubit-0.9.safetensors" "$LORA_DIR/ltx-2.3-22b-ic-lora-dubit-0.9.safetensors"
...
mkdir /workspace/ComfyUI/custom_nodes/GetAudioDurationSeconds/
